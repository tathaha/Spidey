...
public class Guilds extends TableImpl<GuildsRecord> {
    ...
    /**
     * The column <code>public.guilds.vip</code>.
     */
    public final TableField<GuildsRecord, Boolean> VIP = createField(DSL.name("vip"), SQLDataType.BOOLEAN.defaultValue(DSL.field("false", SQLDataType.BOOLEAN)), this, "");
